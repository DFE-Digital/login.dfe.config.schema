...
const schema = new SimpleSchema({
  ...
  'notifications.sms.type': {
    type: String,
    allowedValues: ['disk', 'GovNotify']
  },
  'notifications.sms.params': {
    type: Object,
    optional: true,
    custom: function () {
      if (this.siblingField('type').value !== 'disk' && !this.isSet) {
  ...
  'notifications.sms.params.apiKey': {
    type: String,
    optional: true,
    custom: function () {
      if (this.field('notifications.sms.type').value === 'GovNotify' && !this.isSet) {
        return SimpleSchema.ErrorTypes.REQUIRED
      }
    },
  },
  'notifications.sms.params.templates': {
    type: Object,
    optional: true,
    custom: function () {
      if (this.field('notifications.sms.type').value === 'GovNotify' && !this.isSet) {
  ...
  publicApi: Object,
  'publicApi.directories': Object,
  'publicApi.directories.type': {
    type: String,
    allowedValues: ['static', 'api'],
  },
  'publicApi.directories.service': apiAuth,
  'publicApi.organisations': Object,
  'publicApi.organisations.type': {
    type: String,
    allowedValues: ['static', 'api'],
  },
  'publicApi.organisations.service': apiAuth,
  'publicApi.auth': Object,
  'publicApi.auth.jwtSecret': String,
});
